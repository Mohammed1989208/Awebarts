...
<!--			<button type="submit"  name="submit" value="Login" >LOGIN</button>-->
	...
	<form class="register-form" action="controllers/LoginController.php" method="post">
		<h3>Sign Up</h3>
...
<!--			<button type="submit" id="register-submit-btn" name class="btn btn-success uppercase pull-right">Submit</button>-->
